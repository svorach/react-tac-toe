...
/******/ 	__webpack_require__.p = "http://localhost:1337/dist";
/******/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ticTacToe = __webpack_require__(185);
	...
	var TicTacToe = function (_React$Component) {
	  ...
	  function TicTacToe(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TicTacToe).call(this, props));
	  ...
	  _createClass(TicTacToe, [{
	    ...
	    value: function move(event) {
	      ...
	      _ticTacToe2.default.dispatch({
	        type: 'MOVE',
	        x: parseInt(x, 10),
	        y: parseInt(y, 10),
	        player: _ticTacToe2.default.getState().player
	      });
	...
	var render = function render() {
	  _reactDom2.default.render(_react2.default.createElement(TicTacToe, _ticTacToe2.default.getState()), document.getElementById('root'));
	};
	
	_ticTacToe2.default.subscribe(render);
	_ticTacToe2.default.dispatch({ type: 'INIT' });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Winner = __webpack_require__(177);
	
	var _Winner2 = _interopRequireDefault(_Winner);
	
	var _winConditions = __webpack_require__(180);
	
	__webpack_require__(183);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var getWinner = function getWinner(matrix) {
	  var horizontalWinner = (0, _winConditions.horizontal)(matrix);
	  var verticalWinner = (0, _winConditions.vertical)(matrix);
	  var diagonalWinner = (0, _winConditions.diagonal)(matrix);
	  var tieGame = (0, _winConditions.tie)(matrix);
	...
	var Board = function Board(_ref) {
	  ...
	  var displayWinner = function displayWinner() {
	    var hasWinner = function hasWinner() {
	      return typeof winner.player !== 'undefined';
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Tile = __webpack_require__(170);
	...
	var Row = function Row(_ref) {
	  ...
	  var mappedRows = row.map(function (claim, i) {
	    return _react2.default.createElement(_Tile2.default, { key: i, claim: claim, rowIndex: index, index: i, move: move });
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tile = function Tile(_ref) {
	  ...
	  return _react2.default.createElement(
	    'button',
	    opts,
	    claim ? _react2.default.createElement(
	      'span',
	      { className: 'claim' },
	      claim
	    ) : ''
	...
	Tile.propTypes = {
	  claim: _react2.default.PropTypes.string.isRequired,
	  index: _react2.default.PropTypes.number.isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Winner = function Winner(_ref) {
	  ...
	  return _react2.default.createElement(
	    'div',
	    { className: 'winner animated scale-in-dramatic' },
	    _react2.default.createElement(
	      'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _array = __webpack_require__(181);
	
	var _matrix = __webpack_require__(182);
	
	var winConditions = {
	  horizontal: function horizontal(matrix) {
	    for (var rowIndex = 0; rowIndex < matrix.length; rowIndex++) {
	      var player = (0, _array.equalContents)(matrix[rowIndex]);
	  ...
	  vertical: function vertical(matrix) {
	    for (var colIndex = 0; colIndex < matrix[0].length; colIndex++) {
	      var col = (0, _matrix.getColumn)(matrix, colIndex);
	      var player = (0, _array.equalContents)(col);
	  ...
	  diagonal: function diagonal(matrix) {
	    var _getDiagonals = (0, _matrix.getDiagonals)(matrix);
	
	    var downward = _getDiagonals.downward;
	    var upward = _getDiagonals.upward;
	
	    var player = (0, _array.equalContents)(downward) || (0, _array.equalContents)(upward);
	
	    return player || false;
	  },
	
	  tie: function tie(matrix) {
	    var size = (0, _matrix.getSize)(matrix);
	    var claimed = '';
	
	    matrix.forEach(function (row, idx) {
	      claimed += matrix[idx].reduce(function (a, b) {
	        return a + b;
	      });
	    });
...
/***/ function(module, exports) {
	...
	module.exports = {
	  equalContents: function equalContents(array) {
	    if (!array.length) {
	      return false;
	    }
...
/***/ function(module, exports) {
	...
	module.exports = {
	  getSize: function getSize(matrix) {
	    var size = 0;
	  ...
	  getColumn: function getColumn(matrix, columnIndex) {
	    var col = [];
	  ...
	  getDiagonals: function getDiagonals(matrix) {
	    ...
	    return { downward: downward, upward: upward };
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(193)(global || window || this);
...
/***/ function(module, exports) {
	...
	var player = function player() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? 'o' : arguments[0];
	  var action = arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var board = function board() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? new _matrix.Matrix() : arguments[0];
	  var action = arguments[1];
